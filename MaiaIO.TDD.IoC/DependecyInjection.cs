...
using MaiaIO.TDD.Domain.Devices.Servicos;
...
using MaiaIO.TDD.Infra.Devices.Repositories;
...
namespace MaiaIO.TDD.IoC
{
    public static class DependecyInjection
    {
        ...
        public static IServiceCollection DIConfig(this IServiceCollection services)
        {
            ...
            //services.AddScoped<IProductionLineDapperRepository, ProductionLineDapperRepository>();


            services.Scan(scan =>
                    scan.FromAssembliesOf(typeof(ProductionLineAppService))
                    .AddClasses()
            ...
            services.Scan(scan =>
                    scan.FromAssembliesOf(typeof(DeviceService))
                    .AddClasses()
                    .AsImplementedInterfaces()
                    .WithScopedLifetime()
             );
            ...
            services.Scan(scan =>
                    scan.FromAssembliesOf(typeof(DeviceRepository))
                    .AddClasses()
                    .AsImplementedInterfaces()
                    .WithScopedLifetime()
             );
